...
function useClickOutside(ref, onClickOutside = noop2, {
  ...
  const handleMouseCapture = (0, import_react37.useCallback)((e) => {
    ...
    preventMouseClickOutsideRef.current = !currentTarget || isModifiedEvent(e) || !isLeftClickEvent(e) || !!contains2(currentTarget, e.target);
  }, [ref]);
...
var $9d939cbc98267846$var$SSRContext = import_react39.default.createContext($9d939cbc98267846$var$defaultContext);
function $9d939cbc98267846$export$9f8ac96af4b1b2ae(props) {
  let cur = (0, import_react39.useContext)($9d939cbc98267846$var$SSRContext);
  ...
  return import_react39.default.createElement($9d939cbc98267846$var$SSRContext.Provider, {
    value
  }, props.children);
}
...
function $9d939cbc98267846$export$619500959fc48b26(defaultId) {
  let ctx = (0, import_react39.useContext)($9d939cbc98267846$var$SSRContext);
...
var Offcanvas = React87.forwardRef((_a, ref) => {
  ...
  const renderBackdrop = (0, import_react66.useCallback)((backdropProps) => (0, import_jsx_runtime83.jsx)("div", __spreadProps(__spreadValues({}, backdropProps), {
...
var NavbarOffcanvas = React88.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime84.jsx)(Offcanvas_default, __spreadValues({
    ref,
...
function useOverlayOffset() {
  ...
  const offset2 = (0, import_react71.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
...
function OverlayTrigger(_a) {
  ...
  return (0, import_jsx_runtime94.jsxs)(import_jsx_runtime93.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react73.cloneElement)(children, triggerProps), (0, import_jsx_runtime92.jsx)(Overlay_default2, __spreadProps(__spreadValues({}, props), {
      show,
      onHide: handleHide,
      flip: flip2,
      placement,
...
var _excluded9 = ["active", "eventKey", "mountOnEnter", "transition", "unmountOnExit", "role"];
...
function getTabTransitionComponent(transition) {
  if (typeof transition === "boolean") {
    return transition ? Fade_default : void 0;
  }
  return transition;
}
...
var Table = React111.forwardRef((_a, ref) => {
  ...
  const classes = (0, import_classnames69.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size2 && `${decoratedBsPrefix}-${size2}`, striped && `${decoratedBsPrefix}-striped`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
...
var ToastContainer = React117.forwardRef((_a, ref) => {
  ...
  return (0, import_jsx_runtime120.jsx)(Component2, __spreadProps(__spreadValues({
    ...
    className: (0, import_classnames72.default)(bsPrefix, position && `position-absolute ${positionClasses[position]}`, className)
  }));
});
